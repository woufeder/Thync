                  ...
                  <div className="hero-overlay">
                    <div className="hero-content">
                      <div className="hero-meta">
                        <span className="hero-category">{article.category_name || '未分類'}</span>
                        <span className="hero-date">{formatDate(article.created_at)}</span>
                      </div>
                      <h1 className="hero-title">{article.title}</h1>
                      <div className="hero-stats">
                        <div className="stat-badge">
                          <svg width="16" height="16" viewBox="0 0 16 17" fill="none">
                            <path d="M8.00065 1.52335C4.32065 1.52335 1.33398 4.51001 1.33398 8.19001C1.33398 11.87 4.32065 14.8567 8.00065 14.8567C11.6807 14.8567 14.6673 11.87 14.6673 8.19001C14.6673 4.51001 11.6807 1.52335 8.00065 1.52335ZM8.00065 13.5233C5.06065 13.5233 2.66732 11.13 2.66732 8.19001C2.66732 5.25001 5.06065 2.85668 8.00065 2.85668C10.9407 2.85668 13.334 5.25001 13.334 8.19001C13.334 11.13 10.9407 13.5233 8.00065 13.5233Z" fill="white" />
                            <path d="M8.33398 4.85666H7.33398V8.85666L10.834 10.9567L11.334 10.1367L8.33398 8.35666V4.85666Z" fill="white" />
                          </svg>
                          <span>約 8 分鐘閱讀</span>
                        </div>
                        <div className="stat-badge">
                ...
                <div className="article-header-fallback">
                  <div className="header-content">
                    <div className="article-meta-row">
                      <span className="article-category-badge">{article.category_name || '未分類'}</span>
                      <span className="article-date-text">{formatDate(article.created_at)}</span>
                    </div>
                    <h1 className="article-main-title">{article.title}</h1>
                    <div className="article-stats-row">
                      <div className="stat-item-inline">
                        <svg width="16" height="16" viewBox="0 0 16 17" fill="none">
                          <path d="M8.00065 1.52335C4.32065 1.52335 1.33398 4.51001 1.33398 8.19001C1.33398 11.87 4.32065 14.8567 8.00065 14.8567C11.6807 14.8567 14.6673 11.87 14.6673 8.19001C14.6673 4.51001 11.6807 1.52335 8.00065 1.52335ZM8.00065 13.5233C5.06065 13.5233 2.66732 11.13 2.66732 8.19001C2.66732 5.25001 5.06065 2.85668 8.00065 2.85668C10.9407 2.85668 13.334 5.25001 13.334 8.19001C13.334 11.13 10.9407 13.5233 8.00065 13.5233Z" fill="#6B6A67" />
                          <path d="M8.33398 4.85666H7.33398V8.85666L10.834 10.9567L11.334 10.1367L8.33398 8.35666V4.85666Z" fill="#6B6A67" />
                        </svg>
                        <span>約 8 分鐘閱讀</span>
                      </div>
                      <div className="stat-item-inline">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                          <path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" fill="#6B6A67" />
                        </svg>
                        <span>{article.views || 0} 次閱讀</span>
                      </div>
                    </div>
            ...
            <article className="article-main">
              ...
              <div className="author-banner">
                <div className="author-info-enhanced">
                  <img src="/images/admin.jpg" alt="Author" className="author-avatar-large" />
                  <div className="author-details-enhanced">
                    <span className="author-name-large">財神爺小編</span>
                    <span className="author-title">科技編輯</span>
                    <span className="publish-info">發布於 {formatDate(article.created_at)}</span>
                  </div>
                </div>
                <div className="article-actions-preview">
                  <button className="action-btn-preview like-preview">
                ...
                <div className="article-meta-footer">
                  ...
                  <div className="engagement-actions">
                    <div className="engagement-buttons">
                      <button className="engagement-btn like-btn">
                        ...
                        <div className="btn-content">
                          <span className="btn-text">喜歡</span>
                          <span className="btn-subtext">覺得實用</span>
                        </div>
                      </button>
                      ...
                      <button className="engagement-btn share-btn">
                        ...
                        <div className="btn-content">
                          ...
                          <span className="btn-subtext">讓更多人看見</span>
                        </div>
                      </button>
                    </div>
                    ...
                    <div className="social-share">
                      <span className="social-share-label">分享到：</span>
      ...
      <div className="scroll-top" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
        <svg width="44" height="50" viewBox="0 0 44 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_334_546)">
            <path d="M6.25 7.8125C5.39062 7.8125 4.6875 8.51562 4.6875 9.375V40.625C4.6875 41.4844 5.39062 42.1875 6.25 42.1875H37.5C38.3594 42.1875 39.0625 41.4844 39.0625 40.625V9.375C39.0625 8.51562 38.3594 7.8125 37.5 7.8125H6.25ZM0 9.375C0 5.92773 2.80273 3.125 6.25 3.125H37.5C40.9473 3.125 43.75 5.92773 43.75 9.375V40.625C43.75 44.0723 40.9473 46.875 37.5 46.875H6.25C2.80273 46.875 0 44.0723 0 40.625V9.375ZM21.875 15.625C22.5293 15.625 23.1445 15.8984 23.5938 16.377L33.75 27.3145C34.3848 27.998 34.5508 28.9941 34.1797 29.8438C33.8086 30.6934 32.959 31.25 32.0312 31.25H11.7188C10.791 31.25 9.94141 30.6934 9.57031 29.8438C9.19922 28.9941 9.36523 27.998 10 27.3145L20.1562 16.377C20.5957 15.8984 21.2207 15.625 21.875 15.625Z" fill="#304A6F" />
          </g>
          <defs>
